        ...
        this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService",
          function(t, n, a, o) {
            ...
            function d(e) {
              ...
              for (var d = t; d <= n; d++) a = new Date(e.getFullYear(), e.getMonth(), d),
            ...
            return u.today = i(new Date).getTime(),
              ...
              u.setIonicDatePickerTodayDate = function() {
                ...
                u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch), p())
              },
              ...
              s.openDatePicker = function(t,currDate) {
                var a = [];
                delete u.fromDate,
                  delete u.toDate,
