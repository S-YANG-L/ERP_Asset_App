 ...
 */
Asset.controller('outBoundSelectCtrl', ['$scope', '$state', 'outBoundSelectService', '$ionicHistory', 'DataService', 'UrlService', 'PopupService', '$localstorage', '$stateParams','UserService',
  function ($scope, $state, outBoundSelectService, $ionicHistory, DataService, UrlService, PopupService, $localstorage, $stateParams,UserService) {
    //进入页面后初始化页面
    ...
    var getData = function () {
      ...
      outBoundSelectService.getData(params)
...
Asset.service('outBoundSelectService', ['$http', 'UrlService', function ($http, UrlService) {
