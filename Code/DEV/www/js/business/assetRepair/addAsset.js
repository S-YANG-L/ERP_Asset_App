 ...
 */
Asset.controller('addAssetCtrl',['$ionicActionSheetRecording','$scope','newAssetService', '$state','$ionicLoading', 'UrlService','PopupService','$localstorage','$ionicHistory', '$cordovaImagePicker', '$ionicActionSheet', 'httpUtil', 'PopupService', '$filter', 'ionicDatePicker', 'ionicTimePicker','$cordovaCamera', 'DataService',
